...
class SemKITTI_pt(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask_idx = torch.zeros((len(pts)), 3, dtype=torch.int)
        count = 0
        ...
        for i in range(1, len(mask_center)):
            mask_center[i] /= mask_count[i].item()
...
class spherical_dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return_fea = np.concatenate((return_fea, xyz_center_pol, xyz_center[:, :2]), axis=1)  # us
