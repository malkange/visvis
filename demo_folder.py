...
from configs.config import load_config_data # us
...
def main(args):
    ...
    demo_loss_list = []
    with torch.no_grad():
        for i_iter_demo, (_, demo_vox_label, demo_grid, demo_pt_labs, demo_pt_fea, _) in enumerate( # us add _
                demo_dataset_loader):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='configs/semantickitti.yaml') # us
